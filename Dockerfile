...
ENV         GCC_VERSION=3.9.5
ENV         GCC_DEST=Python-${GCC_VERSION}
ENV         GCC_SRC_FILE=${GCC_DEST}.tar.xz
ENV         GCC_URL=https://www.python.org/ftp/python/${GCC_VERSION}/${GCC_SRC_FILE}
ENV         GCC_HOME=/usr/local/${GCC_DEST}
http://ftp.tsukuba.wide.ad.jp/software/gcc/releases/gcc-11.1.0/gcc-11.1.0.tar.xz
